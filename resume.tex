...
\begin{itemize}
    ...
    \item {\bfseries Technologies:}
        ...
        Elasticsearch, Kafka
    \item {\bfseries Tools:}
        Git, SVN, Vim, Visual Studio, Android Studio, IntelliJ IDEA, Eclipse,
        Ansible, Terraform
\end{itemize}
...
\begin{itemize}
    ...
    \item Earned 2,200,000+ downloads, 4.5 stars with 11,000+ reviews on Google
      Play.
\end{itemize}
...
\vspace{-3mm}
\begin{itemize}
    \item Achieved a 93.1\% cumulative average.
\end{itemize}
\end{document}
